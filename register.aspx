<%@ Page Language="C#" AutoEventWireup="true"  Culture="auto" UICulture="auto" CodeFile="register.aspx.cs" Inherits="register" %>
...
<script type="text/javascript">
    ...
    <style type="text/css">
        ...
        .midBox{width:950px; background:#fff url(img/search_Top.jpg) center 10px no-repeat;margin:0px auto; padding:10px;}
        .cnt{width:910px; background:url(img/search_Bottom.jpg) bottom no-repeat;margin-top:82px;padding:6px 20px 20px;}
   ...
   .rightSchList{ width:480px;margin-left:10px;float:left; display:inline;}
    ...
    .button{margin-top: 10px; margin-bottom: 10px;padding:2px 12px 2px 12px;}
    </style>     
          ...
          <tr bgcolor="#FFFFFF"> 
            ...
            SelectCommand="SELECT [ACADEMICNAME] FROM [培养单位表_武汉大学]"></asp:AccessDataSource>      
             ...
             <tr bgcolor="#ffffff" style="height: 37px"> 
                  ...
                  <td align="left" width="70%" style="padding-left: 10px">
                  <span id ="zy" >
                  <select class ="xselect" id = "DropDownList2" runat="Server">
                    <option value = "请先选择申请院系">请先选择申请院系</option>
                  </select>
                  </span>
            ...
            onfocus="this.select()"  name="tb_csrq" runat="Server" class="bbsInput_short" />
             ...
             <tr bgcolor="#ffffff" style="height: 37px"> 
                  ...
                  <td align="left" width="70%" style="padding-left: 10px">
                     ...
                     <input id="Button4" type="button" value="上传" onclick="upload()"/> <br />
             ...
             <tr bgcolor="#f7f7f7" style="height: 37px"> 
                  ...
                  <asp:TextBox ID="xxxTextBox1" runat="server" 
                      ...
                      <input id="Button2" type="button" value="本科学校已撤销" onclick = "  $('#xxxTextBox1').attr('value','本科学校已撤销')" />
                      <input id="Button3" type="button" value="境外教育机构"  onclick = "  $('#xxxTextBox1').attr('value','境外教育机构')"/>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="!!!" ControlToValidate="Slider2"></asp:RequiredFieldValidator>
             ...
             <!-- <input id="Submit1" type="submit" value="提&nbsp;&nbsp;交"  onclick = "return lastcheck();" /> !-->
                 <asp:Button ID="Submit1"  Text="注 册" 
...
////////////////////////L A S T C H E C K//////////////////////////////////////////
        var lastcheck = function () {
            ...
            if (idcheck != 7) {
                if (idcheck == 3 || idcheck == 6) alert("身份证号末位校验错误");
                else alert("身份证号中包含的性别、出生日期信息与选择的性别或出生日期不相符"); return false;
            }
            //电话号码验证
