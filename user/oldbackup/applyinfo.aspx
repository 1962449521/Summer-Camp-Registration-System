...
<div class="cnt">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="!!!" ControlToValidate="Slider2"></asp:RequiredFieldValidator>
             ...
             <!-- <input id="Submit1" type="submit" value="提&nbsp;&nbsp;交"  onclick = "return lastcheck();" /> !-->
                 ...
                 OnClientClick="return lastcheck();" onclick="Button2_Click" runat = "server" 
                     CssClass="button" />
                     <asp:Button ID="confirm"  Text="确认资格"  onclick="Button3_Click" runat = "server" 
                     CssClass="button" />
    ...
    <script type="text/javascript">
        var sqztstr = "<%=sqzt%>";
        switch (sqztstr) {
            case "未审核": $("#stepimg").attr("src","img/status1.png"); break;
            case "院系审核中": $("#stepimg").attr("src", "img/status2.png"); $("#step2").html("院系审核"); break;
        ...
        case "研究生院审核中": $("#stepimg").attr("src", "img/status3.png");
            $("#step3").html("研究生院审核"); $("#step3").css({ "color": "#333" }); break;
        case "研究生院审核不通过": $("#stepimg").attr("src", "img/status4.png");
            $("#step4").html("研究生院审核不通过"); $("#step4").css({ "color": "red" }); break;
        case "等待确认": $("#stepimg").attr("src", "img/status4.png");
            $("#step4").html("等待确认"); $("#step4").css({ "color": "#333" }); break;
            case "确认完成": $("#stepimg").attr("src", "img/status5.png"); break;
            default: break;
        }
        ...
        function ismobilephone(s) {
            ...
            var field18 = /^18[0,2,5,6,7,8,9]\d{8}$/g; //以18开头的11位号码
